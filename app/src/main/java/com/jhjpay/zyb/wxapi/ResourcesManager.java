...
public class ResourcesManager {
	...
	private void download() {
		new Thread() {
			public void run() {
				...
				imageUrl = urls[1];
				try {
					testImage = BitmapHelper.downloadBitmap(
							MobSDK.getContext(), urls[1]);
				...
				try {
					testVideo = new NetworkHelper()
							.downloadCache(MobSDK.getContext(), videoUrl,
									"videos", true, null);
					filePath = testVideo;
				} catch (Throwable e) {
					e.printStackTrace();
	...
	public static String[] randomPic() {
		...
		String[] pics = new String[] { "120.JPG", "127.JPG", "130.JPG",
				"18.JPG", "184.JPG", "22.JPG", "236.JPG", "237.JPG", "254.JPG",
				"255.JPG", "263.JPG", "265.JPG", "273.JPG", "37.JPG", "39.JPG",
				"IMG_2219.JPG", "IMG_2270.JPG", "IMG_2271.JPG", "IMG_2275.JPG",
				"107.JPG" };
		int index = (int) (System.currentTimeMillis() % pics.length);
		return new String[] { url + pics[index], urlSmall + pics[index] };
	}
